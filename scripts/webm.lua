...
local options = {
	...
	-- avc-videotoolbox (h264-apple-videotoolbox)
	-- webm-vp8 (libvpx/libvorbis)
	-- gif
	-- mp3 (libmp3lame)
	-- and raw (rawvideo/pcm_s16le).
	output_format = "avc-videotoolbox",
	twopass = true,
...
do
  ...
  _class_0 = setmetatable({
    __init = function(self)
      self.displayName = "h264-apple-videotoolbox"
      self.supportsTwopass = true
      self.videoCodec = "h264_videotoolbox"
      self.audioCodec = "aac"
      self.outputExtension = "mp4"
      self.acceptsBitrate = true
    end,
    __base = _base_0,
    __name = "AVCVideoToolbox",
    __parent = _parent_0
  }, {
    __index = function(cls, name)
      local val = rawget(_base_0, name)
  ...
  AVCVideoToolbox = _class_0
end
formats["avc-videotoolbox"] = AVCVideoToolbox()
local AV1
do
  local _class_0
  local _parent_0 = Format
...
local get_mpv_executable
get_mpv_executable = function()
  local common_paths = {
  ...
  for _index_0 = 1, #common_paths do
    local path = common_paths[_index_0]
